...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <link rel="stylesheet" href="http://static.taotao.com/css/base.css">
   <link href="http://static.taotao.com/css/purchase.2012.css?v=201410141639" rel="stylesheet" type="text/css">
...
<div class="w cart">
	<div class="cart-hd group">
		...
		<span id="show2" class="fore"> <span>现在&nbsp;</span><a class="btn" href="http://sso.taotao.com/user/login.html"><span class="btn-text">登录</span></a><span>， 您购物车中的商品将被永久保存</span>
 		</c:if>
 </span>
	</div>
	<div id="show">
...
<script type="text/javascript" src="http://static.taotao.com/js/base-v1.js"></script>
<!-- footer start -->
<jsp:include page="../commons/footer.jsp" />
<!-- footer end -->

<!-- 购物车相关业务 -->
<script type="text/javascript" src="http://static.taotao.com/js/cart.js"></script>
<script type="text/javascript" src="http://static.taotao.com/js/jquery.price_format.2.0.min.js"></script>
